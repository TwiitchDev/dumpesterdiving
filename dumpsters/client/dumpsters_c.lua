...
-- You can replace the notification even here if you do not use native qb notifications
RegisterNetEvent('bprp-dumpsters:notifications')
AddEventHandler('bprp-dumpsters:notifications', function(msg, type)
...
exports[TargetName]:AddTargetModel(DumpsterProp, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster",
            icon = "fas fa-box",
...
exports[TargetName]:AddTargetModel(DumpsterProp2, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster2",
            icon = "fas fa-box",
            label = Config.Lang['searchdumpster'],
        },
    },
...
exports[TargetName]:AddTargetModel(DumpsterProp3, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster3",
            icon = "fas fa-box",
            label = Config.Lang['searchdumpster'],
        },
    },
...
exports[TargetName]:AddTargetModel(DumpsterProp4, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster4",
            icon = "fas fa-box",
            label = Config.Lang['searchdumpster'],
        },
    },
...
exports[TargetName]:AddTargetModel(DumpsterProp5, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster5",
            icon = "fas fa-box",
            label = Config.Lang['searchdumpster'],
        },
    },
...
exports[TargetName]:AddTargetModel(DumpsterProp6, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchDumpster6",
            icon = "fas fa-box",
            label = Config.Lang['searchdumpster'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin",
            icon = "fas fa-box",
...
exports[TargetName]:AddTargetModel(BinProp2, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin2",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp3, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin3",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp4, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin4",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp5, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin5",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp6, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin6",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp7, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin7",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp8, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin8",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp9, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin9",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp10, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin10",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
exports[TargetName]:AddTargetModel(BinProp11, {
    options = {
        {
            event = "bprp-dumpsters:client:SearchBin11",
            icon = "fas fa-box",
            label = Config.Lang['searchbin'],
        },
    },
...
--Search dumpsters
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster', function()
        ...
        if DoesEntityExist(Dumpster) then
            ...
            dumpster = GetEntityCoords(entity)                
                if not SearchedDumpster[entity] then
                    ...
                    TriggerEvent('bprp-dumpsters:notifications', Config.Lang['alreadysearched'], 'error')
                end
            break
        else
            Wait(CoolDown * 1000)
...
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster2', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster3', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster4', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster5', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
RegisterNetEvent('bprp-dumpsters:client:SearchDumpster6', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
function SearchDumpster(entity)
    ...
    TriggerServerEvent('bprp-dumpsters:server:SearchDumpster')
    end)
end
--<!>-- DUMPSTERS CODE END --<!>--

--<!>-- BINS CODE START --<!>--
RegisterNetEvent('bprp-dumpsters:client:SearchBin', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin2', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp2 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin3', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp3 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin4', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp4 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin5', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp5 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin6', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp6 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin7', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp7 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin8', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp8 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin9', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
    for i = 1, #BinProp9 do
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin10', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
RegisterNetEvent('bprp-dumpsters:client:SearchBin11', function()
    local playerPed = PlayerPedId()
    local playerCoords = GetEntityCoords(playerPed)
...
function SearchBin(entity)
    ...
    ClearPedTasks(playerPed)
    TriggerServerEvent('bprp-dumpsters:server:SearchBin')
    end)
end
--<!>-- BINS CODE END --<!>--
