...
Config = {}
-- Core info
Config.Core = 'QBCore' -- The name of your core. Default; BOII
...
Config.TrashItems = { --<!>-- THERE WILL BE ITEMS IN THIS LIST NOT IN YOUR CITY! PLEASE MAKE SURE TO REMOVE THEM AND UPDATE WITH YOUR ITEMS! --<!>--
    'tosti',
	'twerks_candy',
	'snikkel_candy',
	'coffee',
